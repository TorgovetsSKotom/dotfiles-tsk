...
// IMPORTANT VARIABLES
var booru, storage, requestPost, requestNote, requestCount, requestCache, requestTag, reqTagTimer, tagTimer, noteclearTimer;
...
aTags.addEventListener("input", function(e) {
    ...
    reqTagTimer = setTimeout(function() {
        ...
        requestTag = xmlhttpRequest({
            method : "GET",
            url : "http://danbooru.donmai.us/tags.xml?search[hide_empty]=yes&search[order]=count&search[name_matches]=" + lookuptag + "*",
            headers : {
